          ...
          <div class="card wow fadeInUpBig hoverable p-2 mb-1" data-wow-delay="1s">
            <div class="feature">
              <div class = "technology-card card-block text-center">
                ...
                <h4 class = "mt-1">Ruby</h4>
                <p class="grey-text">
                   Ruby on Rails is an open source web framework for building custom web applications.
                </p>
              </div>
            </div>
          </div>
