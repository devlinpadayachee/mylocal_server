      ...
      <div class="container-fluid center-text">
         <div class="row justify-content-md-center mt-3">
            <div class="col-lg-12 text-center">
               <h1 class="text-primary">Our <strong>Services</strong></h1>
            </div>
         </div>
      </div>
      <div class="container-fluid center-text">
         ...
         <div class="row">
            ...
            <div class="col-lg-4 col-xl-4 pr-lg-4 mb-r center-on-small-only flex-center">
               <img src="../assets/img/homeimage.png" alt="Div 0 Image" class="z-depth-0 mx-auto d-block">
            </div>
            <div class="col-lg-4 col-xl-4 pr-lg-4">
               <div class="row mb-2">
                  <div class="col-1 mr-1">
